...
Route::group(['prefix' => 'admin', 'middleware' => 'auth.checkrole:admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['prefix' => 'estados', 'as' => 'estados.'], function () {
        ...
        Route::group(['prefix' => 'cidades', 'as' => 'cidades.'], function () {
            Route::get('', [
                'as' => 'index',
                'uses' => 'Admin\CidadesController@index'
            ]);
            Route::get('create', [
                'as' => 'create',
                'uses' => 'Admin\CidadesController@create'
            ]);
            Route::get('print/{id}', [
                'as' => 'print',
                'uses' => 'Admin\CidadesController@printReport'
            ]);
            Route::get('show/{id}', [
                'as' => 'show',
                'uses' => 'Admin\CidadesController@show'
            ]);
            Route::get('edit/{id}', [
                'as' => 'edit',
                'uses' => 'Admin\CidadesController@edit'
            ]);
            Route::post('store', [
                'as' => 'store',
                'uses' => 'Admin\CidadesController@store'
            ]);
            Route::post('update/{id}', [
                'as' => 'update',
                'uses' => 'Admin\CidadesController@update'
            ]);
            Route::get('destroy/{id}', [
                'as' => 'destroy',
                'uses' => 'Admin\CidadesController@destroy'
            ]);
            Route::post('destroy', [
                'as' => 'destroySelected',
                'uses' => 'Admin\CidadesController@destroySelected'
            ]);
        });
    });
