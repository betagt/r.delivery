...
@endsection
@section('header')
    <a href="{{ route('admin.estabelecimentos.create') }}" class="btn btn-primary btn-flat mb"><i class="fa fa-plus"></i> Novo Registro</a>
@endsection
@section('list')
...
@endsection
@section('options')
    <a href="{{ route('admin.estabelecimentos.categories.create', ['estabelecimento_id' => $entity->id]) }}" class="btn btn-default btn-flat">
