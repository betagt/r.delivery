...
@section('breadcrumbs')
    {!! Breadcrumbs::render('admin_estabelecimentos_create') !!}
@endsection
@section('content')
    {!! Form::Open(['route'=>'admin.estabelecimentos.store', "enctype" => "multipart/form-data"]) !!}
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            @include('admin.estabelecimentos._form')
        </div>
